...
class StateGenerator:
    ...
    def get_child_state(self, state, move):
        ...
        self.change_colors(new_state, move[0], move[1])
        return new_state

    # defines the slope (direction) that check_direction looks in from the flipped piece
    def change_colors(self, state, row, column):
